...
header{
    background: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)), url("contact.png");
    height: 100vh;
...
p a{
    ...
    <body>
        <header>
            ...
            <div class="homepg">
                <h1><p>contact no: 081-932411</p>
        <p>E-mail:onlinebank@gmail.com</p>
        <p>instagram:onlineBANK_081</p>
</h1>
